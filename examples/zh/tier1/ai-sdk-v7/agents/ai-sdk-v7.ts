...
//
// 断言依据(工具/消息/HITL)全部从协议帧直构,工厂替你做好。这是 Tier 1(只接 send);
// 要 `niceeval view` 的调用瀑布图时升 Tier 2(../../tier2/ai-sdk-v7/):同一个文件加一行
// settleMs、config 加一行 telemetry,evals/experiments 原样复用。
