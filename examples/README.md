...
五个应用黑盒接入(不改被测应用一行代码),对应 `docs/origin-integration.md` 的工单,全部实测跑通:
...
| [`zh/tier1/codex-sdk/`](zh/tier1/codex-sdk/) | 黑盒接 `@openai/codex-sdk`,手写 `ThreadEvent` SSE 映射,真实编码任务 eval(建文件/跑命令),声明 `tracing` 但省略 `spanMapper` | [文档](../docs-site/zh/example/tier1-codex-sdk.mdx) |
...
| [`zh/tier1/ai-sdk-v7/`](zh/tier1/ai-sdk-v7/) | 黑盒接 AI SDK v7 的 HTTP 接口(不是内建 `aiSdkAgent` 那条路),客户端带全量历史续接,`events: otelEvents({dialects:[otel.genAi]})` | [文档](../docs-site/zh/example/tier1-ai-sdk-v7.mdx) |
