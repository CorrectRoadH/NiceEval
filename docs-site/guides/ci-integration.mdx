---
title: "Run niceeval evals in GitHub Actions and CI pipelines"
sidebarTitle: "CI Integration"
description: "Integrate niceeval into GitHub Actions or any CI system. Evals exit non-zero on failure, report JUnit XML, and cache results to speed up repeat runs."
---
