...
export const MODELS: ModelDef[] = [
  ...
  // gpt-5.4 本身支持视觉；但 image-understanding eval 经当前 OPENAI_BASE_URL 网关传图会被拒
  // ("Expected a valid URL" —— 网关转 Responses API 时不认 data URL)。这一条是 ai-sdk-v7
  // 特有的偏离(ai-sdk-v7-before 没跑过 eval，没触发这个问题)；直连 OpenAI 或换个支持图像
  // 输入的网关后，把它改回 true，image-understanding 就会真跑。
  { id: "gpt-5.4",           label: "GPT-5.4",            provider: "openai",   contextTokens: 400_000, supportsVision: false },
];
