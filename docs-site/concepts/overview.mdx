...
description: "Understand how NiceEval, agent adapters, and sandbox backends work together to evaluate any AI agent through one API."
---

NiceEval separates **what you evaluate** from **how the subject under test is connected**. NiceEval discovers evals, schedules runs, scores assertions, and writes reports. Agent adapters call the system under test. Sandbox backends isolate filesystems for coding-agent tasks.
