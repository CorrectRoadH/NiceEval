...
description: "niceeval is an agent-native TypeScript eval library for AI agents. Evaluate coding agents and your own agent applications with one unified API."
---

niceeval is an agent-native TypeScript library for structured, repeatable evaluation of AI agents. Instead of manually poking at your agent and hoping for the best, you write declarative eval files that describe what a good result looks like, and niceeval takes care of running them, scoring the output, and producing readable reports. Whether you're shipping a Claude Code plugin, a Codex workflow, or your own AI agent application, niceeval gives you the same `defineEval` API.
