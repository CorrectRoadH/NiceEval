...
**Docker** — required only for sandbox evals (coding agents like Claude Code, Codex, and bub that need an isolated filesystem). Install [Docker Desktop](https://www.docker.com/products/docker-desktop/) or Docker Engine and confirm it's running before you attempt a sandbox eval. Direct agent evals work without Docker.
...
**For custom agents**, add whatever variables your adapter reads — for example:
