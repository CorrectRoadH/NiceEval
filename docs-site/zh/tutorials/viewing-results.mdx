...
│ 2026-07-07 16:40  ✗ 失败  calledTool("get_weather") · 未调用            12.4s   $0.05  @1w3k0dqe │
│ 2026-07-08 11:05  ✓ 通过  —                                             8.9s   $0.03  @1m82hyqk │
│ 2026-07-08 18:22  ✗ 失败  calledTool("get_weather") · 未调用            11.7s   $0.05  @19fjq2xw │
│ 2026-07-09 08:12  ✓ 通过  —                                             9.2s   $0.03  @1zpk57vn │
│ 2026-07-09 10:00  ✗ 失败  calledTool("get_weather") · 未调用            13.1s   $0.04  @1c4vmt8d │
╰──────────────────────────────────────────────────────────────────────────────────────────────────╯
```
