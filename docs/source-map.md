...
| 排版原语 Row / Col / Section / Text / Style / Tabs / Tab / Table(八个内置双面组件;Table 的 text 面在 `src/report/definition/table-text.ts`,官方表状组件共用;`Tab` 只能直接放在 `<Tabs>` 下,不参与路由、没有 id) | `src/report/definition/primitives.tsx` |
