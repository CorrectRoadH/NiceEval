...
The shape corresponds to codex config.toml's [mcp_servers.&lt;name&gt;] table.
...
- [OTel integration](/guides/connect-otel) — send your app's spans to [NiceEval](https://niceeval.com/) in exchange for the call waterfall in `niceeval view`.
