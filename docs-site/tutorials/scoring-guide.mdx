...
A good eval should decompose "did this succeed?" into signals you can explain. [NiceEval](https://niceeval.com/) lets you mix precise assertions, semantic judge checks, event-stream checks, and real tests.
