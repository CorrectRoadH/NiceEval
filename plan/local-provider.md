...
- `docs/engineering/unit-tests/sandbox/cases.md` 「Local provider」分区：4 行。
- `docs/engineering/unit-tests/experiments-runner/cases.md` 「并发」分区新增的 exclusive 行；全局上限解析行的括号已加 `local 1`。
