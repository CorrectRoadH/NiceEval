...
- [Reports 测试架构](../docs/engineering/unit-tests/reports/README.md)
- [Reports 用例登记表](../docs/engineering/unit-tests/reports/cases.md)
...
| 测试登记 | [`cases.md`](../docs/engineering/unit-tests/reports/cases.md) 没有 Grid / Stat / Section.meta 场景 | 先登记对应场景，再写实现测试；不新增未登记测试 |
...
- [ ] 在 [`docs/engineering/unit-tests/reports/cases.md`](../docs/engineering/unit-tests/reports/cases.md) 的“Table 与文本排版原语”登记且只登记以下新增场景：
