...
CI can upload the JUnit XML so failures appear in the test-report UI. To also report results to an experiment platform such as Braintrust, see [Reporters](/guides/reporters).
