---
title: "Connect a remote or in-process agent to niceeval"
sidebarTitle: "Remote Agent"
description: "Use defineAgent to wrap any function or HTTP service as a niceeval agent. Map responses to the standard event stream and register the agent by name."
---
