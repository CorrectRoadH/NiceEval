...
NiceEval 把中文文档发布在 npm 包的 `docs-site/zh/` 目录。AI 应该读取 `node_modules/niceeval/docs-site/zh/`，而不是依赖训练数据或网上另一个版本的示例。这样 API、CLI 和安装版本始终一致。
...
```text
先读取 node_modules/niceeval/docs-site/zh/ 下与当前任务有关的文档，
...
```text
读取 node_modules/niceeval/docs-site/zh/ 中与任务有关的文档。
