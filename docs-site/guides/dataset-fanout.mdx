...
npx fasteval exp local sql

# Run only the first case
npx fasteval exp local sql/0000

# Run cases 0–2
npx fasteval exp local sql/0000 sql/0001 sql/0002
```
